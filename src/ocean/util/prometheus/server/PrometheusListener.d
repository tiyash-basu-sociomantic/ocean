...
/*******************************************************************************
    ...
    Params:
        ...
        PrometheusHandler     = Collects stats from registered collectors and
                                prepares the reponse message to prometheus' stat
                                pull requests.
        CollectorRegistry     = Acts as a collection or a registry of stat
                                collection callbacks that is needed by the
                                handlers.
        EpollSelectDispatcher = The dispatcher, required by the fiber framework
                                in the handler.
        size_t                = The datatype of the stack size, required by the
                                fiber framework in the handler.
